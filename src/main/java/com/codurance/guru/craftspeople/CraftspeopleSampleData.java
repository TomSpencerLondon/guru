...
public class CraftspeopleSampleData {
    ...
    public void appReady(ApplicationReadyEvent event) {
        ...
        repository.save(new Craftsperson("Sam", "Davies"));
        ...
        repository.save(new Craftsperson("Aurelija", "Zubaviciute"));
        ...
        repository.save(new Craftsperson("Tacuma", "Bellford"));
        ...
        repository.save(new Craftsperson("Alexandru", "Ignat"));
        ...
        repository.save(new Craftsperson("Jocelyn", "Facchini"));
